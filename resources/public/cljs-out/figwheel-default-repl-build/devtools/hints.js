...
var file = cljs.core.get.call(null,map__13236__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13236__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13236__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e13235){var _e = e13235;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___13238 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___13238)){
var seen_errors_13239 = temp__5718__auto___13238;
if(cljs.core.truth_(seen_errors_13239.has(self))){
} else {
seen_errors_13239.add(self);

var temp__5720__auto___13240 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___13240)){
var sense_13241 = temp__5720__auto___13240;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13241)].join(''));
} else {
}
}
} else {

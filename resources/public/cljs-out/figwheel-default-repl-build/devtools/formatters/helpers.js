...
var G__11033 = devtools.prefs.pref.call(null,v);
v = G__11033;
continue;
} else {
return v;
...
}catch (e11036){var _e__10044__auto__ = e11036;
return false;
}})();
...
}catch (e11040){var _e__10044__auto__ = e11040;
return false;
}})();
...
}catch (e11042){var _e__10044__auto__ = e11042;
return false;
}}
}
});
...
var vec__11044 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11044,(0),null);
var name = cljs.core.nth.call(null,vec__11044,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11047_SHARP_);
}),template);
});

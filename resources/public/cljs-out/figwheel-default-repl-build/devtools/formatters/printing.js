...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11059){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11060,G__11061,seq11059__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11065_SHARP_){
return (!((cljs.core.meta.call(null,p1__11065_SHARP_) == null)));
})))){
...
var map__11066 = opts;
var map__11066__$1 = (((((!((map__11066 == null))))?(((((map__11066.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11066.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11066):map__11066);
var markup_db = cljs.core.get.call(null,map__11066__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11070){var _e__10044__auto__ = e11070;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e11072){var _e__10044__auto__ = e11072;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11074 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11075 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11075);

try{var map__11076 = opts;
...
var markup_db = cljs.core.get.call(null,map__11076__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11074);
}});
...
var temp__5718__auto___11081 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___11081)){
var managed_print_level_11082 = temp__5718__auto___11081;
var _STAR_print_level_STAR__orig_val__11079_11083 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11080_11084 = managed_print_level_11082;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11080_11084);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__11078_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11078_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11079_11083);
}} else {
job_fn.call(null);
}

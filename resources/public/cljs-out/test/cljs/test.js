...
var G__17249 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__17249,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__17249;
}
}));
...
var len__4736__auto___17254 = arguments.length;
var i__4737__auto___17255 = (0);
while(true){
if((i__4737__auto___17255 < len__4736__auto___17254)){
args__4742__auto__.push((arguments[i__4737__auto___17255]));

var G__17256 = (i__4737__auto___17255 + (1));
i__4737__auto___17255 = G__17256;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17251){
var G__17252 = cljs.core.first.call(null,seq17251);
var seq17251__$1 = cljs.core.next.call(null,seq17251);
var G__17253 = cljs.core.first.call(null,seq17251__$1);
var seq17251__$2 = cljs.core.next.call(null,seq17251__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17252,G__17253,seq17251__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__17257_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17257_SHARP_));
...
var temp__5720__auto___17260 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17260)){
var message_17261 = temp__5720__auto___17260;
cljs.core.println.call(null,message_17261);
} else {
}
...
var temp__5720__auto___17262 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17262)){
var message_17263 = temp__5720__auto___17262;
cljs.core.println.call(null,message_17263);
} else {
}
...
var output_dir__$1 = (function (){var G__17264 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__17264,"/"].join('');
} else {
return G__17264;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__17266 = exception.stack;
var G__17266__$1 = (((G__17266 == null))?null:clojure.string.split_lines.call(null,G__17266));
var G__17266__$2 = (((G__17266__$1 == null))?null:cljs.core.get.call(null,G__17266__$1,depth));
if((G__17266__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__17266__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__17267 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17267,(0),null);
var column = cljs.core.nth.call(null,vec__17267,(1),null);
var vec__17270 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17270,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17270,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17270,(2),null);
...
var m__$1 = (function (){var G__17273 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__17273__$1 = (((G__17273 instanceof cljs.core.Keyword))?G__17273.fqn:null);
switch (G__17273__$1) {
case "fail":
...
var G__17277 = (function (){var G__17276 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__17276);
} else {
return G__17276;
}
})();
...
return cljs.core.vary_meta.call(null,G__17278,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e17279){var e = e17279;
var G__17280 = e;
var G__17280__$1 = (((G__17280 instanceof cljs.core.Keyword))?G__17280.fqn:null);
switch (G__17280__$1) {
...
var vec__17282 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17282,(0),null);
var types = vec__17282;
...
return cljs.core.map.call(null,(function (p__17285){
var vec__17286 = p__17285;
var ns = cljs.core.nth.call(null,vec__17286,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17286,(1),null);
return (function (){
...
var G__17289 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__17289__$1 = (((G__17289 instanceof cljs.core.Keyword))?G__17289.fqn:null);
switch (G__17289__$1) {
case "async":
...
var seq__17290 = cljs.core.seq.call(null,vars__$1);
var chunk__17291 = null;
var count__17292 = (0);
var i__17293 = (0);
while(true){
if((i__17293 < count__17292)){
var v = cljs.core._nth.call(null,chunk__17291,i__17293);
var temp__5720__auto___17295 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___17295)){
var t_17296 = temp__5720__auto___17295;
each_fixture_fn.call(null,((function (seq__17290,chunk__17291,count__17292,i__17293,t_17296,temp__5720__auto___17295,v,each_fixture_fn,G__17289,G__17289__$1,env,once_fixtures,each_fixtures,vec__17286,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17296)));
});})(seq__17290,chunk__17291,count__17292,i__17293,t_17296,temp__5720__auto___17295,v,each_fixture_fn,G__17289,G__17289__$1,env,once_fixtures,each_fixtures,vec__17286,ns,vars__$1))
);
} else {
}


var G__17297 = seq__17290;
var G__17298 = chunk__17291;
var G__17299 = count__17292;
var G__17300 = (i__17293 + (1));
seq__17290 = G__17297;
chunk__17291 = G__17298;
count__17292 = G__17299;
i__17293 = G__17300;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__17290);
if(temp__5720__auto__){
var seq__17290__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17290__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__17290__$1);
var G__17301 = cljs.core.chunk_rest.call(null,seq__17290__$1);
var G__17302 = c__4556__auto__;
var G__17303 = cljs.core.count.call(null,c__4556__auto__);
var G__17304 = (0);
seq__17290 = G__17301;
chunk__17291 = G__17302;
count__17292 = G__17303;
i__17293 = G__17304;
continue;
} else {
var v = cljs.core.first.call(null,seq__17290__$1);
var temp__5720__auto___17305__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___17305__$1)){
var t_17306 = temp__5720__auto___17305__$1;
each_fixture_fn.call(null,((function (seq__17290,chunk__17291,count__17292,i__17293,t_17306,temp__5720__auto___17305__$1,v,seq__17290__$1,temp__5720__auto__,each_fixture_fn,G__17289,G__17289__$1,env,once_fixtures,each_fixtures,vec__17286,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17306)));
});})(seq__17290,chunk__17291,count__17292,i__17293,t_17306,temp__5720__auto___17305__$1,v,seq__17290__$1,temp__5720__auto__,each_fixture_fn,G__17289,G__17289__$1,env,once_fixtures,each_fixtures,vec__17286,ns,vars__$1))
);
} else {
}


var G__17307 = cljs.core.next.call(null,seq__17290__$1);
var G__17308 = null;
var G__17309 = (0);
var G__17310 = (0);
seq__17290 = G__17307;
chunk__17291 = G__17308;
count__17292 = G__17309;
i__17293 = G__17310;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17289__$1)].join('')));

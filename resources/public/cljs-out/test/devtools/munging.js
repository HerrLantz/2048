...
var o18446 = temp__5718__auto__;
var temp__5718__auto____$1 = (o18446["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o18447 = temp__5718__auto____$1;
return (o18447["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17555__auto__ = f;
return (o__17555__auto__["toString"]).call(o__17555__auto__);
} else {
return "";
}
}catch (e18448){var _ = e18448;
return "";
}});
...
try{var o__17555__auto___18450 = t;
(o__17555__auto___18450["cljs$lang$ctorPrWriter"]).call(o__17555__auto___18450,t,writer);
}catch (e18449){var __18451 = e18449;
}
...
var char_code = (function (){var o__17555__auto__ = (new String(char$));
return (o__17555__auto__["charCodeAt"]).call(o__17555__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17555__auto__ = String;
return (o__17555__auto__["fromCharCode"]).call(o__17555__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18452 = num_code;
switch (G__18452) {
case (1):
return (185);
...
var o__17555__auto__ = String;
return (o__17555__auto__["fromCharCode"]).call(o__17555__auto__,superscript_code);
});
/**
...
}catch (e18454){var _e__17562__auto__ = e18454;
return false;
}})())){
...
var vec__18455 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18455,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o18458 = temp__5718__auto__;
var temp__5718__auto____$1 = (o18458["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o18459 = temp__5718__auto____$1;
return (o18459["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___18466 = arguments.length;
var i__4737__auto___18467 = (0);
while(true){
if((i__4737__auto___18467 < len__4736__auto___18466)){
args__4742__auto__.push((arguments[i__4737__auto___18467]));

var G__18468 = (i__4737__auto___18467 + (1));
i__4737__auto___18467 = G__18468;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18462){
var vec__18463 = p__18462;
var ns_detector = cljs.core.nth.call(null,vec__18463,(0),null);
...
var G__18469 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18470 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18469;
remaining_tokens = G__18470;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18460){
var G__18461 = cljs.core.first.call(null,seq18460);
var seq18460__$1 = cljs.core.next.call(null,seq18460);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18461,seq18460__$1);
}));
...
var vec__18474 = cljs.core.split_with.call(null,(function (p1__18473_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18473_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18474,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18474,(1),null);
...
var vec__18480 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18480,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18480,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18483 = cljs.core.rest.call(null,remaining_tokens);
var G__18484 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18483;
name_tokens = G__18484;
continue;
} else {
...
var vec__18487 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18487,(0),null);
var arity = cljs.core.nth.call(null,vec__18487,(1),null);
var vec__18490 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18490,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18490,(1),null);
var vec__18493 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18493,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18493,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18493,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18493,(3),null);
...
var vec__18499 = result;
var munged_ns = cljs.core.nth.call(null,vec__18499,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18499,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18499,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18499,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18499,(4),null);
var arity = cljs.core.nth.call(null,vec__18499,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__18503 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__18503,(0),null);
var args = cljs.core.nth.call(null,vec__18503,(1),null);
var vec__18506 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18506,(0),null);
var name = cljs.core.nth.call(null,vec__18506,(1),null);
...
var G__18509 = (arity + (1));
var G__18510 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18511){
var vec__18512 = p__18511;
var arity = cljs.core.nth.call(null,vec__18512,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18512,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18515_SHARP_){
return cljs.core.get.call(null,arities,p1__18515_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__18516_SHARP_){
return cljs.core.drop.call(null,(2),p1__18516_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___18523 = arguments.length;
var i__4737__auto___18524 = (0);
while(true){
if((i__4737__auto___18524 < len__4736__auto___18523)){
args__4742__auto__.push((arguments[i__4737__auto___18524]));

var G__18525 = (i__4737__auto___18524 + (1));
i__4737__auto___18524 = G__18525;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18519){
var vec__18520 = p__18519;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18520,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18517){
var G__18518 = cljs.core.first.call(null,seq18517);
var seq18517__$1 = cljs.core.next.call(null,seq18517);
var self__4723__auto__ = this;
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__18528__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18528__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18528__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18528__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18529 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18529,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18529,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18529,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18529,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18529,(4),null);
var arity = cljs.core.nth.call(null,vec__18529,(5),null);
...
var o__17555__auto__ = f;
return (o__17555__auto__["getBasis"]).call(o__17555__auto__);
});
/**
...
}catch (e18533){var _e__17562__auto__ = e18533;
...
var G__18534 = (obj[cljs.core.first.call(null,path)]);
var G__18535 = cljs.core.rest.call(null,path);
obj = G__18534;
path = G__18535;
continue;
} else {
...
var _STAR_ = (function (accum,p__18536){
var vec__18537 = p__18536;
var bit = cljs.core.nth.call(null,vec__18537,(0),null);
var protocol = cljs.core.nth.call(null,vec__18537,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18540){
var vec__18541 = p__18540;
var ns = cljs.core.nth.call(null,vec__18541,(0),null);
var name = cljs.core.nth.call(null,vec__18541,(1),null);
var selector = cljs.core.nth.call(null,vec__18541,(2),null);
...
var post_process = (function (p__18545){
var vec__18546 = p__18545;
var munged_name = cljs.core.nth.call(null,vec__18546,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18546,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18544_SHARP_){
return (obj[cljs.core.first.call(null,p1__18544_SHARP_)]);
}),sorted_matches);

...
var G__18551 = devtools.prefs.pref.call(null,v);
v = G__18551;
continue;
} else {
return v;
...
}catch (e18554){var _e__17562__auto__ = e18554;
return false;
}})();
...
}catch (e18558){var _e__17562__auto__ = e18558;
return false;
}})();
...
}catch (e18560){var _e__17562__auto__ = e18560;
return false;
}}
}
});
...
var vec__18562 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18562,(0),null);
var name = cljs.core.nth.call(null,vec__18562,(1),null);
...
return cljs.core.some.call(null,(function (p1__18565_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18565_SHARP_);
}),template);
});

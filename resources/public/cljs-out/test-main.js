window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=f279cf&fwbuild=test"};
...
document.write('<script>goog.require("game_2048.test_runner");</script>');

...
var G__17915 = o;
goog.object.set(G__17915,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__17916__delegate = function (args){
...
while (G__17917__i < G__17917__a.length) {G__17917__a[G__17917__i] = arguments[G__17917__i + 0]; ++G__17917__i;}
  args = new cljs.core.IndexedSeq(G__17917__a,0,null);
} 
return G__17916__delegate.call(this,args);};
...
return G__17916__delegate(args);
});
...
var G__17919 = o;
goog.object.set(G__17919,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__17920__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
G__17920.cljs$lang$applyTo = (function (arglist__17922){
...
var G__17923 = props;
var G__17923__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__17923,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17923);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17923__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__17923__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__17924 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__17924,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__17924;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__17925){
...
var on_write = cljs.core.get.call(null,map__17926__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__17928_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17928_SHARP_);
}));
} else {
return null;
}
...
var vec__17931 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17931,(0),null);
var id = cljs.core.nth.call(null,vec__17931,(1),null);
var className = cljs.core.nth.call(null,vec__17931,(2),null);
...
var temp__5724__auto___17935 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___17935 == null)){
} else {
var key_17936 = temp__5724__auto___17935;
(jsprops.key = key_17936);
}
...
var temp__5724__auto___17937 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___17937 == null)){
} else {
var key_17938 = temp__5724__auto___17937;
(jsprops.key = key_17938);
}
...
var temp__5724__auto___17939 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___17939 == null)){
} else {
var key_17940 = temp__5724__auto___17939;
(jsprops.key = key_17940);
}
...
var G__17942 = n;
if(cljs.core._EQ_.call(null,"",G__17942)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__17942)){
return x;
} else {
...
var len__4736__auto___17945 = arguments.length;
var i__4737__auto___17946 = (0);
while(true){
if((i__4737__auto___17946 < len__4736__auto___17945)){
args__4742__auto__.push((arguments[i__4737__auto___17946]));

var G__17947 = (i__4737__auto___17946 + (1));
i__4737__auto___17946 = G__17947;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17943){
var G__17944 = cljs.core.first.call(null,seq17943);
var seq17943__$1 = cljs.core.next.call(null,seq17943);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17944,seq17943__$1);
}));
...
break;
default:
var G__17950 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__17950;
continue;
...
var ctx = ({});
var vec__17952 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__17952,(0),null);
var derefed = cljs.core.nth.call(null,vec__17952,(1),null);
...
var G__17955 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17955) {
case (0):

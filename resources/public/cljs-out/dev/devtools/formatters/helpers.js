...
var G__19031 = devtools.prefs.pref.call(null,v);
v = G__19031;
continue;
} else {
return v;
...
}catch (e19034){var _e__18042__auto__ = e19034;
return false;
}})();
...
}catch (e19038){var _e__18042__auto__ = e19038;
return false;
}})();
...
}catch (e19040){var _e__18042__auto__ = e19040;
return false;
}}
}
});
...
var vec__19042 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19042,(0),null);
var name = cljs.core.nth.call(null,vec__19042,(1),null);
...
return cljs.core.some.call(null,(function (p1__19045_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19045_SHARP_);
}),template);
});

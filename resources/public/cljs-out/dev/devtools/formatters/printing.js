...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19057){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19058,G__19059,seq19057__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19063_SHARP_){
return (!((cljs.core.meta.call(null,p1__19063_SHARP_) == null)));
})))){
...
var map__19064 = opts;
var map__19064__$1 = (((((!((map__19064 == null))))?(((((map__19064.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19064.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19064):map__19064);
var markup_db = cljs.core.get.call(null,map__19064__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19068){var _e__18042__auto__ = e19068;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e19070){var _e__18042__auto__ = e19070;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__19072 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__19073 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__19073);

try{var map__19074 = opts;
var map__19074__$1 = (((((!((map__19074 == null))))?(((((map__19074.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19074.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19074):map__19074);
var markup_db = cljs.core.get.call(null,map__19074__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__19072);
}});
...
var temp__5718__auto___19079 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___19079)){
var managed_print_level_19080 = temp__5718__auto___19079;
var _STAR_print_level_STAR__orig_val__19077_19081 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__19078_19082 = managed_print_level_19080;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__19078_19082);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__19076_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19076_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__19077_19081);
}} else {
job_fn.call(null);
}

...
var o18926 = temp__5718__auto__;
var temp__5718__auto____$1 = (o18926["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o18927 = temp__5718__auto____$1;
return (o18927["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__18035__auto__ = f;
return (o__18035__auto__["toString"]).call(o__18035__auto__);
} else {
return "";
}
}catch (e18928){var _ = e18928;
return "";
}});
...
try{var o__18035__auto___18930 = t;
(o__18035__auto___18930["cljs$lang$ctorPrWriter"]).call(o__18035__auto___18930,t,writer);
}catch (e18929){var __18931 = e18929;
}
...
var char_code = (function (){var o__18035__auto__ = (new String(char$));
return (o__18035__auto__["charCodeAt"]).call(o__18035__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__18035__auto__ = String;
return (o__18035__auto__["fromCharCode"]).call(o__18035__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18932 = num_code;
switch (G__18932) {
case (1):
return (185);
...
var o__18035__auto__ = String;
return (o__18035__auto__["fromCharCode"]).call(o__18035__auto__,superscript_code);
});
/**
...
}catch (e18934){var _e__18042__auto__ = e18934;
return false;
}})())){
...
var vec__18935 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18935,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o18938 = temp__5718__auto__;
var temp__5718__auto____$1 = (o18938["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o18939 = temp__5718__auto____$1;
return (o18939["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18942){
var vec__18943 = p__18942;
var ns_detector = cljs.core.nth.call(null,vec__18943,(0),null);
...
var G__18949 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18950 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18949;
remaining_tokens = G__18950;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18940){
...
var vec__18954 = cljs.core.split_with.call(null,(function (p1__18953_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18953_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18954,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18954,(1),null);
...
var vec__18960 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18960,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18960,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18963 = cljs.core.rest.call(null,remaining_tokens);
var G__18964 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18963;
name_tokens = G__18964;
continue;
} else {
...
var vec__18967 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18967,(0),null);
var arity = cljs.core.nth.call(null,vec__18967,(1),null);
var vec__18970 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18970,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18970,(1),null);
var vec__18973 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18973,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18973,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18973,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18973,(3),null);
...
var vec__18979 = result;
var munged_ns = cljs.core.nth.call(null,vec__18979,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18979,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18979,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18979,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18979,(4),null);
var arity = cljs.core.nth.call(null,vec__18979,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__18983 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__18983,(0),null);
var args = cljs.core.nth.call(null,vec__18983,(1),null);
var vec__18986 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18986,(0),null);
var name = cljs.core.nth.call(null,vec__18986,(1),null);
...
var G__18989 = (arity + (1));
var G__18990 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18991){
var vec__18992 = p__18991;
var arity = cljs.core.nth.call(null,vec__18992,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18992,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__18995_SHARP_){
return cljs.core.get.call(null,arities,p1__18995_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__18996_SHARP_){
return cljs.core.drop.call(null,(2),p1__18996_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___19003 = arguments.length;
var i__4737__auto___19004 = (0);
while(true){
if((i__4737__auto___19004 < len__4736__auto___19003)){
args__4742__auto__.push((arguments[i__4737__auto___19004]));

var G__19005 = (i__4737__auto___19004 + (1));
i__4737__auto___19004 = G__19005;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18999){
var vec__19000 = p__18999;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19000,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18997){
var G__18998 = cljs.core.first.call(null,seq18997);
var seq18997__$1 = cljs.core.next.call(null,seq18997);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18998,seq18997__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19008__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19008__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19008__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19008__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19009 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19009,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19009,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19009,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19009,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19009,(4),null);
var arity = cljs.core.nth.call(null,vec__19009,(5),null);
...
var o__18035__auto__ = f;
return (o__18035__auto__["getBasis"]).call(o__18035__auto__);
});
/**
...
}catch (e19013){var _e__18042__auto__ = e19013;
...
var G__19014 = (obj[cljs.core.first.call(null,path)]);
var G__19015 = cljs.core.rest.call(null,path);
obj = G__19014;
path = G__19015;
continue;
} else {
...
var _STAR_ = (function (accum,p__19016){
var vec__19017 = p__19016;
var bit = cljs.core.nth.call(null,vec__19017,(0),null);
var protocol = cljs.core.nth.call(null,vec__19017,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19020){
...
var selector = cljs.core.nth.call(null,vec__19021,(2),null);
...
var post_process = (function (p__19025){
var vec__19026 = p__19025;
var munged_name = cljs.core.nth.call(null,vec__19026,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19026,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__19024_SHARP_){
return (obj[cljs.core.first.call(null,p1__19024_SHARP_)]);
}),sorted_matches);

...
var G__17262 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__17262,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__17262;
}
}));
...
var len__4736__auto___17267 = arguments.length;
var i__4737__auto___17268 = (0);
while(true){
if((i__4737__auto___17268 < len__4736__auto___17267)){
args__4742__auto__.push((arguments[i__4737__auto___17268]));

var G__17269 = (i__4737__auto___17268 + (1));
i__4737__auto___17268 = G__17269;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17264){
var G__17265 = cljs.core.first.call(null,seq17264);
var seq17264__$1 = cljs.core.next.call(null,seq17264);
var G__17266 = cljs.core.first.call(null,seq17264__$1);
var seq17264__$2 = cljs.core.next.call(null,seq17264__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17265,G__17266,seq17264__$2);
}));
...
var file = cljs.core.get.call(null,map__17271__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__17271__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17271__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__17270_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17270_SHARP_));
...
var temp__5720__auto___17273 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17273)){
var message_17274 = temp__5720__auto___17273;
cljs.core.println.call(null,message_17274);
} else {
}
...
var temp__5720__auto___17275 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___17275)){
var message_17276 = temp__5720__auto___17275;
cljs.core.println.call(null,message_17276);
} else {
}
...
var output_dir__$1 = (function (){var G__17277 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__17277,"/"].join('');
} else {
return G__17277;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__17279 = exception.stack;
var G__17279__$1 = (((G__17279 == null))?null:clojure.string.split_lines.call(null,G__17279));
var G__17279__$2 = (((G__17279__$1 == null))?null:cljs.core.get.call(null,G__17279__$1,depth));
if((G__17279__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__17279__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__17280 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17280,(0),null);
var column = cljs.core.nth.call(null,vec__17280,(1),null);
var vec__17283 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17283,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17283,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17283,(2),null);
...
var m__$1 = (function (){var G__17286 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__17290 = (function (){var G__17289 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__17289);
} else {
return G__17289;
}
})();
...
return cljs.core.vary_meta.call(null,G__17291,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e17292){var e = e17292;
var G__17293 = e;
var G__17293__$1 = (((G__17293 instanceof cljs.core.Keyword))?G__17293.fqn:null);
switch (G__17293__$1) {
...
var vec__17295 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17295,(0),null);
var types = vec__17295;
...
return cljs.core.map.call(null,(function (p__17298){
var vec__17299 = p__17298;
var ns = cljs.core.nth.call(null,vec__17299,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17299,(1),null);
return (function (){
...
var G__17302 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__17302__$1 = (((G__17302 instanceof cljs.core.Keyword))?G__17302.fqn:null);
switch (G__17302__$1) {
case "async":
...
var seq__17303 = cljs.core.seq.call(null,vars__$1);
var chunk__17304 = null;
var count__17305 = (0);
var i__17306 = (0);
while(true){
if((i__17306 < count__17305)){
var v = cljs.core._nth.call(null,chunk__17304,i__17306);
var temp__5720__auto___17308 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___17308)){
var t_17309 = temp__5720__auto___17308;
each_fixture_fn.call(null,((function (seq__17303,chunk__17304,count__17305,i__17306,t_17309,temp__5720__auto___17308,v,each_fixture_fn,G__17302,G__17302__$1,env,once_fixtures,each_fixtures,vec__17299,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17309)));
});})(seq__17303,chunk__17304,count__17305,i__17306,t_17309,temp__5720__auto___17308,v,each_fixture_fn,G__17302,G__17302__$1,env,once_fixtures,each_fixtures,vec__17299,ns,vars__$1))
);
} else {
}


var G__17310 = seq__17303;
var G__17311 = chunk__17304;
var G__17312 = count__17305;
var G__17313 = (i__17306 + (1));
seq__17303 = G__17310;
chunk__17304 = G__17311;
count__17305 = G__17312;
i__17306 = G__17313;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__17303);
if(temp__5720__auto__){
var seq__17303__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17303__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__17303__$1);
var G__17314 = cljs.core.chunk_rest.call(null,seq__17303__$1);
var G__17315 = c__4556__auto__;
var G__17316 = cljs.core.count.call(null,c__4556__auto__);
var G__17317 = (0);
seq__17303 = G__17314;
chunk__17304 = G__17315;
count__17305 = G__17316;
i__17306 = G__17317;
continue;
} else {
var v = cljs.core.first.call(null,seq__17303__$1);
var temp__5720__auto___17318__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___17318__$1)){
var t_17319 = temp__5720__auto___17318__$1;
each_fixture_fn.call(null,((function (seq__17303,chunk__17304,count__17305,i__17306,t_17319,temp__5720__auto___17318__$1,v,seq__17303__$1,temp__5720__auto__,each_fixture_fn,G__17302,G__17302__$1,env,once_fixtures,each_fixtures,vec__17299,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17319)));
});})(seq__17303,chunk__17304,count__17305,i__17306,t_17319,temp__5720__auto___17318__$1,v,seq__17303__$1,temp__5720__auto__,each_fixture_fn,G__17302,G__17302__$1,env,once_fixtures,each_fixtures,vec__17299,ns,vars__$1))
);
} else {
}


var G__17320 = cljs.core.next.call(null,seq__17303__$1);
var G__17321 = null;
var G__17322 = (0);
var G__17323 = (0);
seq__17303 = G__17320;
chunk__17304 = G__17321;
count__17305 = G__17322;
i__17306 = G__17323;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17302__$1)].join('')));

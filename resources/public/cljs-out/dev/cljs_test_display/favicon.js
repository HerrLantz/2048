...
return cljs.core.map.call(null,(function (p1__18103_SHARP_){
return html_coll.item(p1__18103_SHARP_);
...
return cljs.core.some.call(null,(function (p1__18104_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__18104_SHARP_);
...
var ctx_18105 = cvs.getContext("2d");
(ctx_18105.fillStyle = color);

ctx_18105.fillRect((0),(0),size,size);
